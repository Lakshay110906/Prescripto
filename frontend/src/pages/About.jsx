  ...
  return (
    <div >
      ...
      <div className='flex flex-col md:flex-row mb-20 '>
        <div className='border px-10 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all text-gray-600 cursor-pointer duration-300'> 
          <b>EFFICIENCY:</b>
